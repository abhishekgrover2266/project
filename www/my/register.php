...
/*# sourceMappingURL=style.css.map */
	...
	<section id="register" style="background-image: url('img/247.jpg');">
		...
		<div class="wrapper" style="background-image: url('img/registration-form-2.jpg');background-size:fit;">
			<div class="inner">
                            <form action="register_submit.php" method="post" class="contact_form col-lg-12 col-sm-10">
					...
					<div class="form-group">
						...
						<div class="form-wrapper">
							<label for="">Phone Number</label>
                                                        <input type="text" required="required" name="contact" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<div class="form-wrapper">
					...
					<div class="form-wrapper">
						<label for="">Where did you heared about this contest?</label>
                                                <textarea class="form-control" name="hear"></textarea>
					</div>
					<div class="form-wrapper">
					...
					<div class="form-wrapper">
						<label for="">Upload Half & Full Size Photo /Max-Size:2MB</label>
                                                <input type="file" name="img1" class="form-control" required="required">
