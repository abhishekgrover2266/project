<html>
    ...
    <body ><?php include 'check-if-added.php';?>
          ...
          <nav class="navbar navbar-default" style="padding: 20px 0px 20px 0px;background: white;margin-top: 10px">
                ...
                <div>
                    <ul class="nav navbar-nav" style="font-family: initial;letter-spacing: 6px;">
                        ...
                        <li style="font-size: 20px;padding-right: 40px;color:  plum"><a href="contact.php">Products</a></li>
                    ...
                    <div class="col-xs-5">                         
        <img src="website/cushion/1.jpg" style="height: 500px;width: auto;padding-left: 100px">
                    </div><div class="col-xs-4"style="background: #cc00cc;margin-left: 140px;padding-bottom: 87px;border: solid 1px white"><p style="padding-top: 150px;font-family:  cursive;font-size: 30px;color: white">WHITE CUSHION<br/>
                        <p style="padding-top: 20px;font-family:   sans-serif;font-size: 29px;color: white">RS 300 INR.</p><br><i style="font-size: 20px;color: whitesmoke">Quantity</i></p>
                            <form class="form-group col-xs-2">
                                <input type="number"name="quantity" class="form-control">
                            </form><br><br>
                            <?php  
                    if (check_if_added_to_cart(1)) {  
                    echo '<a href="tesr.php" class="btn btn-block btn-success"  disabled>Added to cart</a>';
                    } else { 
                ?> 
                            <a href="cart-add2.php?id=1" name="add" class="btn btn-block btn-success"style="padding:12px 0px 12px 0px;font-size: 16px">Add to cart</a> 
                <?php 
                } 
        ...
        <p style="font-family:  cursive;"><br><ul style="font-size: 30px;padding-left: 60px;font-family: cursive;color: white">
            ...
            <img src="website/cushion/1.jpg" alt="CUSHION" style="height: 700px;width: 980px">
