...
<html>
    ...
    <body>
       ...
       ?><div class="banner_image">
        ...
        <div class="container">
            <center><h4 style="font-family:  cursive;font-size: 32px;color:  darkred " >PRODUCTS</h4></center>
                                    <div class="row text-center"style="overflow: hidden">
                <div class=" col-md-6 col-sm-6">
                    <div class="thumbnail">
                        <img src="img/p1.jpg" alt="cannon" class="img-responsive" height="1024px" width="720px"style="padding: 50px 0px 50px 0px;content:  var">
                        <div class="caption">
                    ...
                    <div class="thumbnail" >                   
                                                <img src="website/cushion/21.jpg" class="img-responsive">
                                                <div class="caption">
                                                    <a href="products.php" style="color: white"><button class="btn btn-primary btn-block">buy now</button></a>
                        </div>
                                            </div>
